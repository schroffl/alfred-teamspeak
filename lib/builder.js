...
class Builder {
    ...
    /**
     * Image link in the channel description or message
     * 
     * @author      iHDeveloper
     * 
     * @param       {String} url
     * @return      {String} message with image format
     */
    image(url) {
        return this.build('IMG', 'IMG', message);
    }
 ...
 * @return      {String} message with image format
 */
let image = function(url) {
    return build(names.image, url);
}
